...
// she's off to an important fair, so she asks you to write a 
// program that tells her the ratings of the exhibits after 
// removing the lowest one. Fair enough.

// Task
// Given an array of integers, remove the smallest value. 
// Do not mutate the original array/list. If there are multiple 
// elements with the same value, remove the one with the lowest 
